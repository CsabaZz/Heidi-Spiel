...
public interface IDropTarget {
	...
	/**
	 * Handle an object being dropped on the IDropTarget
	 * 
	 * @param source
	...
	void onDragEnter(IDragSource source, int x, int y, int xOffset,
	 ...
	 */
	boolean acceptDrop(IDragSource source, int x, int y, int xOffset,
			int yOffset, DragView dragView, Object dragInfo);
	 ...
	 */
	Rect estimateDropLocation(IDragSource source, int x, int y, int xOffset,

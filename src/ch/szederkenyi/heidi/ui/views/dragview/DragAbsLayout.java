...
@RemoteView
public class DragAbsLayout extends ViewGroup {
	public DragAbsLayout(Context context) {
		super(context);
	}

	public DragAbsLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public DragAbsLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		for (int i = 0; i < count; i++) {
			...
			if (child.getVisibility() != GONE) {
				...
				DragAbsLayout.LayoutParams lp = (DragAbsLayout.LayoutParams) child
						.getLayoutParams();
	...
	public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
		return new DragAbsLayout.LayoutParams(getContext(), attrs);
	}

	// Override to allow type-checking of LayoutParams.
	@Override
	protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
		return p instanceof DragAbsLayout.LayoutParams;
	}
